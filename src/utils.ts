export const isValidStringValue = (arg: any): arg is string => typeof arg === 'string' && arg.length > 0;

export const isHttpProtocol = (arg: any): boolean => isValidStringValue(arg) && /^https?:/i.test(arg);

export const isValidIPv4Address = (arg: any): boolean => {
  if (!isValidStringValue(arg)) return false;
